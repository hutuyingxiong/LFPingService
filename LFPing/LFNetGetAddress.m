...
+ (NETWORK_TYPE)getNetworkTypeFromStatusBar
{
    ...
    if(nettype < NETWORK_TYPE_NONE || NETWORK_TYPE_NONE > NETWORK_TYPE_WIFI) nettype = NETWORK_TYPE_NONE;
    
    if(nettype > NETWORK_TYPE_WIFI || nettype < NETWORK_TYPE_NONE) nettype = NETWORK_TYPE_NONE;
